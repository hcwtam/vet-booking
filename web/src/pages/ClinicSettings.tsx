...
import { changeClinicInfo } from '../utils/user';
import { authContext } from '../store/auth';
import { userContext } from '../store/user';
import { DEFAULT_TIMETABLE, PHONE_REGEX } from '../constants';
import { ClinicSettingsData } from '../types/forms';

export default function ClinicSettings(): ReactElement {
  ...
  const onSubmit = async (values: ClinicSettingsData) => {
